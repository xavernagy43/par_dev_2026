...
| WorkerGroup | Iteráció | Felbontás | Párhuzamos futásidő (ms)  | Szekvenciális futásidő (ms)  | Gyorsítás (S = T_seq / T_par) | Időmegtakarítás (ms) | Időmegtakarítás (%) |
|-------------|----------|-----------|---------------------------|------------------------------|-------------------------------|----------------------|---------------------|
...
| WorkerGroup | Iteráció | Felbontás | Párhuzamos futásidő (ms)  | Szekvenciális futásidő (ms)  | Gyorsítás (S = T_seq / T_par) | Időmegtakarítás (ms) | Időmegtakarítás (%) |
|-------------|----------|-----------|---------------------------|------------------------------|-------------------------------|----------------------|---------------------|
| 128         | 50       | 2048x1024 | 252                       | 117                          | 0.46                          | -135                 | -115.38%            |
| 128         | 100      | 2048x1024 | 246                       | 174                          | 0.71                          | -72                  | -41.38%             |
| 128         | 200      | 2048x1024 | 239                       | 320                          | 1.34                          | 81                   | 25.31%              |
| 128         | 300      | 2048x1024 | 229                       | 436                          | 1.90                          | 207                  | 47.48%              |
| 128         | 500      | 2048x1024 | 248                       | 666                          | 2.69                          | 418                  | 62.76%              |
| 128         | 800      | 2048x1024 | 290                       | 1016                         | 3.50                          | 726                  | 71.46%              |
| 128         | 1000     | 2048x1024 | 296                       | 1251                         | 4.23                          | 955                  | 76.34%              |
| 128         | 1500     | 2048x1024 | 308                       | 1848                         | 6.00                          | 1540                 | 83.35%              |
| 128         | 2000     | 2048x1024 | 312                       | 2467                         | 7.91                          | 2155                 | 87.38%              |
| 128         | 2500     | 2048x1024 | 351                       | 3078                         | 8.77                          | 2727                 | 88.63%              |
...
| WorkerGroup | Iteráció | Felbontás   | Párhuzamos futásidő (ms)  | Szekvenciális futásidő (ms)  | Gyorsítás (S = T_seq / T_par) | Időmegtakarítás (ms) | Időmegtakarítás (%) |
|-------------|----------|-------------|---------------------------|------------------------------|-------------------------------|----------------------|---------------------|
| 256         | 500      | 512x256     | 240                       | 42                           | 0.18                          | -198                 | -471.43%            |
| 256         | 500      | 1024x512    | 238                       | 166                          | 0.70                          | -72                  | -43.37%             |
| 256         | 500      | 1536x768    | 236                       | 395                          | 1.67                          | 159                  | 40.25%              |
| 256         | 500      | 2048x1024   | 257                       | 706                          | 2.75                          | 449                  | 63.60%              |
| 256         | 500      | 2560x1280   | 266                       | 1056                         | 3.97                          | 790                  | 74.81%              |
| 256         | 500      | 3072x1536   | 287                       | 1480                         | 5.16                          | 1193                 | 80.61%              |
| 256         | 500      | 3584x1792   | 295                       | 1984                         | 6.73                          | 1689                 | 85.13%              |
| 256         | 500      | 4096x2048   | 335                       | 2583                         | 7.71                          | 2248                 | 87.03%              |
| 256         | 500      | 4608x2304   | 353                       | 3275                         | 9.28                          | 2922                 | 89.23%              |
| 256         | 500      | 5120x2560   | 418                       | 4044                         | 9.68                          | 3626                 | 89.66%              |
